This example illustrates a simple jrpm use case
It employs the Plugins from org.codehaus.mojo.c-builds to build

IMPORTANT NOTE: c-builds/test-jrpm assumes that it is pulling in a Source tarball from c-builds/m2-repo!! 
...
7.1) cd /myco/pkgs/linux/intel/blah2/1.4.2_09/bin
7.2) myscript.sh

This should print:
  [cberry@cwb test-jrpm]$ /myco/pkgs/linux/intel/blah2/1.4.2_09/bin/myscript.sh
  Hello there. You have called blah/bin/myscript.sh
  Congratulations
