...
/**
 * Retrieve project sources from a local or remote repository.
 * 
 * @goal resolve
 * @phase initialize
 */
        ...
        throws MojoExecutionException, MojoFailureException
    {
        ...
        if ( StringUtils.isEmpty( classifier ) || StringUtils.isEmpty( type ) )
        {
            throw new MojoExecutionException(
                "You must specify both \'classifier\' and \'type\' parameters.\n"
        ...
        catch ( ArtifactResolutionException e )
        {
            ...
            getLog().debug( "Error resolving artifact: " + artifact.getId() + ". Reason: "
                + e.getMessage(), e );
            artifact = null;
        }
        ...
        {
            throw new MojoFailureException( this, "Failed to retrieve project source archive.",
                "Failed to retrieve project source archive. Use debug mode (-X) to see stack traces." );
        }
