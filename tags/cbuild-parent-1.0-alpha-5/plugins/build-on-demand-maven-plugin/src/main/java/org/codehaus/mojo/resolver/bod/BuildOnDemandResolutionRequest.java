...
public class BuildOnDemandResolutionRequest
{
    ...
    public BuildOnDemandResolutionRequest setCompletedBuilds( Set completedBuilds )
    {
    ...
    public BuildOnDemandResolutionRequest setCurrentPendingProjects( List reactorProjects )
    {
