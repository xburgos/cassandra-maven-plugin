    ...
    extends AbstractProjectSourcesMojo
{
        ...
        throws MojoExecutionException
    {
        ...
        try
        {
            ...
            getLog().debug( "project-sources archive contents should include: \n" + archiveIncludes );
            getLog().debug( "project-sources archive contents should exclude: \n" + archiveExcludes );
    ...
    {
        PatchContext patchContext = new PatchContext( this.getSession(), buildAdvisor );
