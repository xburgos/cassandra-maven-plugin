...
public class JacorbTranslator implements CompilerTranslator
{
    ...
    /**
     * Create an <code>JacorbTranslator</code> object with the specified <code>Log</code> and
     ...
     */
    public JacorbTranslator( boolean d, Log l )
    {
        debug = d;
        log = l;
    }
    ...
    /**
     * This methos it's used to redirect an <code>InputeStream</code> to a
