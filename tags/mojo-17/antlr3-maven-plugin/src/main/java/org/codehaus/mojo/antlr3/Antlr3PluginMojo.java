...
public abstract class Antlr3PluginMojo extends AbstractMojo
{
    ...
    private void shortIntoBuildOrder( List grammars )
    {
    ...
    private boolean processGrammarFile( GrammarInfo grammarInfo, File sourceDirectory, File outputDirectory )
