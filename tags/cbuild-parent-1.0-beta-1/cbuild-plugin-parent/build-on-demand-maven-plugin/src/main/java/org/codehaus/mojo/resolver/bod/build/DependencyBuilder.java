...
{
    void buildDependencies( List < MavenProject > dependencyProjects, Set < String > completedBuilds,
        BuildOnDemandResolutionRequest request ) throws BuildOnDemandResolutionException;
}
