...
{
    void findDependenciesWithMissingBinaries( List < MavenProject > dependencyProjects,
        ArtifactRepository localRepository ) throws BuildOnDemandResolutionException;
}
