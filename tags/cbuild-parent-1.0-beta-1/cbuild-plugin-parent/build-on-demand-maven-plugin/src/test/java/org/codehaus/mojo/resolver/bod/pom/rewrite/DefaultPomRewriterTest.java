    ...
    extends TestCase
{
    ...
    private MockControl<PlexusContainer> containerControl;

    private PlexusContainer container;

    private MockControl<ArtifactRepository> localRepoControl;
    ...
    public void testShouldSkipProjectWhichIsExcluded()
    {
        ...
        List<MavenProject> result = rewriter.rewrite( Collections.singletonList( project ), config, localRepo, mh );
