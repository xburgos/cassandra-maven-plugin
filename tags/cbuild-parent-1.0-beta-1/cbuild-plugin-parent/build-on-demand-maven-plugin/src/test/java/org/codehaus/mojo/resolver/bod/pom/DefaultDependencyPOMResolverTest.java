    ...
    extends TestCase
{
    ...
    private MockControl<ArtifactMetadataSource> artifactMetadataSourceControl;

    private ArtifactMetadataSource artifactMetadataSource;

    private MockControl<ArtifactFactory> artifactFactoryControl;

    private ArtifactFactory artifactFactory;

    private MockControl<ArtifactCollector> artifactCollectorControl;

    private ArtifactCollector artifactCollector;

    private MockControl<MavenProjectBuilder> projectBuilderControl;
    ...
    public void testShouldRemoveOneBuildInProgress()
    {
        ...
        DefaultDependencyPOMResolver resolver =
            new DefaultDependencyPOMResolver( artifactMetadataSource, projectBuilder, artifactFactory,
                                              artifactCollector, Logger.LEVEL_DISABLED );
        ...
        Map<String, MavenProject> candidates =
            new HashMap<String, MavenProject>( Collections.singletonMap( ArtifactUtils.versionlessKey( "group", "artifact" ), project ) );
        List<MavenProject> inProgress = Collections.singletonList( project );
    ...
    public void testShouldRemoveOneCompletedBuild()
    {
        ...
        Map<String, MavenProject> candidates =
            new HashMap<String, MavenProject>( Collections.singletonMap( ArtifactUtils.versionlessKey( "group", "artifact" ), project ) );
        Set<String> completed = Collections.singleton( "group:artifact" );
    ...
    public void testShouldFailOnUnresolvableArtifactPOMsDuringCandidateCreation()
    {
        MavenProject project = setupBasicTestProject();

        Artifact dependencyArtifact = setupTestDependencyArtifact();

        // FIXME: Re-enable these when implied version ranges are re-enabled.
        ...
        try
        {
            resolver.resolveBuildCandidateMap( project, null, mh );
            fail( "Should fail when one or more dependency POMs cannot be resolved." );
        }
        ...
        throws BuildOnDemandResolutionException
    {
        ...
        DefaultDependencyPOMResolver resolver =
            new DefaultDependencyPOMResolver( null, null, artifactFactory, artifactCollector, Logger.LEVEL_DISABLED );
        ...
        throws BuildOnDemandResolutionException
    {
        ...
        Artifact dependencyArtifact =
            new DefaultArtifact( "group2", "artifact2", VersionRange.createFromVersion( "version2" ), "compile", "jar",
                                 null, new DefaultArtifactHandler( "jar" ), false );
        ...
        Artifact dependencyPomArtifact =
            new DefaultArtifact( "group2", "artifact2", VersionRange.createFromVersion( "version2" ), "compile", "pom",
                                 null, new DefaultArtifactHandler( "pom" ), false );

        Artifact transdepPomArtifact =
            new DefaultArtifact( "group3", "artifact3", VersionRange.createFromVersion( "version3" ), "compile", "pom",
                                 null, new DefaultArtifactHandler( "pom" ), false );
        ...
        Set<ResolutionNode> nodes = new HashSet<ResolutionNode>( 2 );
        nodes.add( topNode );
        nodes.add( childNode );
        ...
        throws InvalidDependencyVersionException
    {
        ...
        {
            resolver.resolveBuildCandidateMap( project, null, mh );
            fail( "POM resolution failure expected here." );
        }
        catch ( BuildOnDemandResolutionException e )
        {
        }
        ...
        throws BuildOnDemandResolutionException
    {
        ...
        {
            Artifact dependencyArtifact =
                new DefaultArtifact( "group2", "artifact2", VersionRange.createFromVersion( "version2" ), "compile",
                                     "jar", null, new DefaultArtifactHandler( "jar" ), false );

            // FIXME: Re-enable these when implied version ranges are re-enabled.
            // artifactFactory.createDependencyArtifact( "group2", "artifact2", VersionRange.createFromVersion(
            // "version2" ),
            // "jar", null, Artifact.SCOPE_COMPILE, null, false );
            //
            // artifactFactoryControl.setMatcher( MockControl.ALWAYS_MATCHER );
            ...
            Artifact dependencyPomArtifact =
                new DefaultArtifact( "group2", "artifact2", VersionRange.createFromVersion( "version2" ), "compile",
                                     "pom", null, new DefaultArtifactHandler( "pom" ), false );
    ...
    private MavenProject setupBasicTestProject()
    {
        ...
        MockControl<Artifact> projectArtifactControl = MockControl.createControl( Artifact.class );
        mockManager.add( projectArtifactControl );

        Artifact projectArtifact =
            new DefaultArtifact( "group", "artifact", VersionRange.createFromVersion( "version" ), null, "pom", null,
