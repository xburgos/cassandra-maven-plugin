...
/**
 * ScanningUtils will look scan a directory for information
 *
 */
public final class ScanningUtils
{
    ...
    /**
     * Will scan a directory for the last modified time in that directory with 
     * the ability to include/exclude Sets of files in the directory.
     * 
     * @param directory which directory to start the scan
     * @param includes which files to include in the scan
     * @param excludes which files to exclude from the scan
     * @return integer value of the timestamp of the most recently modified file
     */
