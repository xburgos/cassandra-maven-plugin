...
public class FitnesseRunnerMojoTest extends MockObjectTestCase
{
    ...
    public void testPrepareCommandLine() throws MojoExecutionException
    {
        ...
        assertEquals(
                      ...
                      mMojo.prepareCommandLine( mMojo.getFitnesse( 0 ), "bidon.jar;" ).toString() );
    ...
    public void testTransformResultPage() throws MojoExecutionException, IOException
    {
        URL tUrl =
            this.getClass().getClassLoader().getResource( "multiReport/fitnesse/fitnesseResultSuiteCoverage2.html" );
        File tOriginalFile = new File( tUrl.getFile() );
