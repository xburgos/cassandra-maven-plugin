...
/**
 * It is base (abstract) implementation of the connector.
 * It automatically creates ConnectorDescriptor from "/META-INF/connector.xml" file and
 * also keeps connectorContext (getter and setter).
 * 
 * @author Piotr Tabor
 *
 */
public abstract class AbstractDiagramConnector implements DiagramConnector
{
    private ConnectorDescriptor descriptor = null;

    private ConnectorContext connectorContext = null;
