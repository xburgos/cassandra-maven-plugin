...
public interface DiagramConnector{
    ...
    /**
     * If the connector supports the "Static interface" (ConnectorInterfaceEnum.STATIC)
     * the method should return calculated graph. It returns null otherwise  
     *   
     * @param configuration
     * @return
    ...
    /**
     * If the connector supports the "Dynamic interface / Listener model" (ConnectorInterfaceEnum.Dynamic)
     * the method should return DynamicDiagramConnector (for the Listening management - not thread safe, for single use only)  
     *   
     * @param configuration
     * @return
     * @throws ConnectorException
