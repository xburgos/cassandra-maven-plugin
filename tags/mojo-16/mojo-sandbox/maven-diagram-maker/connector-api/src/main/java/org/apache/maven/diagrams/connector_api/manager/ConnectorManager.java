...
/**
 * The class is able to create ConnectorConfiguration class from XML file (and the Connector's description) (from XML method).
 * 
    ...
    private XStream getConfiguredXStream( ConnectorDescriptor desc ) throws ConnectorException
    {
        ...
        for ( Mapping m : desc.getMappings() )
        {
            ...
            if ( m.getConverter() != null )
            {
                ...
                {
                    throw new ConnectorException( "Cannot create instance of class: "
                                    + m.getConverter().getName(), e );
                }
                catch ( IllegalAccessException e )
                {
                    throw new ConnectorException( "Cannot create instance of class: "
