...
public class CloverReportBean extends AbstractReportBean
{
    ...
    {
        return coveredConditionals + " / " + conditionals + " (" + getPercentage( coveredConditionals, conditionals )
                        + ")";
    }
    ...
    {
        return coveredElements + " / " + elements + " (" + getPercentage( coveredElements, elements ) + ")";
    }
    ...
    {
        return coveredMethods + " / " + methods + " (" + getPercentage( coveredMethods, methods ) + ")";
    }
    ...
    {
        return coveredStatements + " / " + statements + " (" + getPercentage( coveredStatements, statements ) + ")";
    }
    ...
    private String getPercentage( int numerator, int denominator )
    {
        ...
        return FormatPercent.format( percentage );
    }
}
