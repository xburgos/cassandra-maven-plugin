 ...
 * <configuration>
    ...
    <ueberArtifact>
      <projectArtifact>false</projectArtifact>
      <include>
        <artifact>org.vafer:dependency</artifact>
      <include>
      <exclude>
        <artifact>org.vafer:dependency</artifact>
      <exclude>
        ...
        throws MojoExecutionException
    {
        ...
        if ( stripUnusedClasses )
        {
            ...
            try
            {
                ...
                final ClazzpathUnit jar = clazzpath.addClazzpathUnit( new FileInputStream( projectArtifactFile ), projectArtifact.getArtifactId(), null);
                ...
                for ( Iterator i = project.getArtifacts().iterator(); i.hasNext(); )
                {
                    ...
                    FileInputStream dependencyStream = new FileInputStream( dependency.getFile() );
                    try {
                    	clazzpath.addClazzpathUnit(dependencyStream, dependency.getArtifactId(), null);
                    } finally {
