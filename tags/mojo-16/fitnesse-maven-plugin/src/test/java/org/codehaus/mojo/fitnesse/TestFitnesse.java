...
public class TestFitnesse extends TestCase
{
    ...
    private void checkGetTypeByDefaultWithDefaultValue( String tDefault ) throws MojoExecutionException
    {
        Fitnesse tFit = new Fitnesse( "localhost", 80, "aWikiSpace.SuiteMySuite" );
        tFit.setType( tDefault );
        assertEquals( Fitnesse.PAGE_TYPE_SUITE, tFit.getType() );

        tFit = new Fitnesse( "localhost", 80, "aWikiSpace.TestMySuite" );
        tFit.setType( tDefault );
        assertEquals( Fitnesse.PAGE_TYPE_TEST, tFit.getType() );

        tFit = new Fitnesse( "localhost", 80, "SuiteWikiSpace.SuiteMySuite" );
        tFit.setType( tDefault );
        assertEquals( Fitnesse.PAGE_TYPE_SUITE, tFit.getType() );

        tFit = new Fitnesse( "localhost", 80, "SuiteWikiSpace.TestMySuite" );
        tFit.setType( tDefault );
        assertEquals( Fitnesse.PAGE_TYPE_TEST, tFit.getType() );

        tFit = new Fitnesse( "localhost", 80, "TestWikiSpace.SuiteMySuite" );
        tFit.setType( tDefault );
        assertEquals( Fitnesse.PAGE_TYPE_SUITE, tFit.getType() );

        tFit = new Fitnesse( "localhost", 80, "TestWikiSpace.TestMySuite" );
        tFit.setType( tDefault );
        assertEquals( Fitnesse.PAGE_TYPE_TEST, tFit.getType() );

        tFit = new Fitnesse( "localhost", 80, "SuiteMySuite" );
        tFit.setType( tDefault );
        assertEquals( Fitnesse.PAGE_TYPE_SUITE, tFit.getType() );

        tFit = new Fitnesse( "localhost", 80, "TestMySuite" );
        tFit.setType( tDefault );
        assertEquals( Fitnesse.PAGE_TYPE_TEST, tFit.getType() );
    }
    ...
    {
        Fitnesse tFit = new Fitnesse( "localhost", 80, "aWikiSpace.ksgkjMySuite" );
        try
        {
            tFit.setType( "" );
            tFit.getType();
        ...
        {
            assertEquals( "Parameter 'type' is mandatory is the page name doesn't begin "
                            + "with 'Test' or 'Suite' according to FitNesse "
                            + "convention. FitNesse server is: Fitnesse "
    ...
    private void checkGetTypeWithExplicitType( String pSuiteParam, String pTestParam ) throws MojoExecutionException
    {
        Fitnesse tFit = new Fitnesse( "localhost", 80, "aWikiSpace.SuiteMySuite" );
    ...
    {
        Fitnesse tFit = new Fitnesse( "localhost", 80, null );
        try
        {
            tFit.checkConfiguration();
            fail( "Should not pass !" );
