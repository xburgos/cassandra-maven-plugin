 ...
 * 
 */
public class SurefirePieChartStrategy extends AbstractPieDatasetStrategy
{
    /**
     * 
     * @param bundle
     */
    public SurefirePieChartStrategy( ResourceBundle bundle )
    {
        super( bundle );
    }
     ...
     * (non-Javadoc)
     * 
     * @see org.codehaus.mojo.dashboard.report.plugin.chart.IDatasetStrategy#createDatasetElement(org.jfree.data.general.Dataset,
     *      org.codehaus.mojo.dashboard.report.plugin.beans.IDashBoardReportBean)
     */
    public void createDatasetElement( Dataset dataset, IDashBoardReportBean dashboardReport )
    {
        if ( dashboardReport instanceof SurefireReportBean )
        {
            SurefireReportBean fireReportBean = (SurefireReportBean) dashboardReport;
