    ...
    extends AbstractOpenJpaMojo
{
        ...
        throws MojoExecutionException
    {
        ...
        filterPersistenceCapable( files );
     ...
     */
    private void filterPersistenceCapable( List files )
    {
        ...
        while ( fileIt.hasNext() ) 
        {
            ...
            else 
            {
                for ( int i = 0; i < classes.length; i++ ) 
                {
                    ...
                    {
                        getLog().debug( "Found class " + classPath + " that implements interface " + PersistenceCapable.class.getName() );
                    }
                    else
                    {
