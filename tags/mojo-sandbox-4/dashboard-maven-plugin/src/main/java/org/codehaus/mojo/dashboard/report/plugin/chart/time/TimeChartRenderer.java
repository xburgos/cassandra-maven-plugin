...
public class TimeChartRenderer extends AbstractChartRenderer
{
    ...
    protected void createChart()
    {
        ...
        DateAxis axisDate = new DateAxis();
        ...
        {
            axisDate.setRangeWithMargins( new DateRange(( (AbstractTimeChartStrategy) this.datasetStrategy ).getStartDate(),
        ...
        int width =
            ( dates.length * ChartUtils.STANDARD_TIME_ENTRY_WIDTH)
