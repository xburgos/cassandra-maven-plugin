 ...
 * Corrections written by <a href="mailto:dvicente72@gmail.com">David Vicente</a>
...
public class CheckstyleErrorsPieChartStrategy extends AbstractPieChartStrategy
{
    ...
    private IDashBoardReportBean mDashboardReport;
    ...
    public void fillDataset()
    {
        if ( mDashboardReport instanceof CheckstyleReportBean )
        {
            ...
            while ( iterator.hasNext() )
            {
                ...
                if ( percentVal > 1 )
                {
                    ( (DefaultPieDataset) this.defaultdataset ).setValue( error.getMessage() + " = " + percentVal + "%",
            ...
            if ( nbItInfPercent > 0 )
            {
                ...
                ( (DefaultPieDataset) this.defaultdataset ).setValue( this.bundle.getString( "chart.checkstyle.violations.others.label" )+ " = " + percentVal + "%", nbItInfPercent );
            }
        }
