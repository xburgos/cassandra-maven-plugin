        ...
        launcher.process = {
                     ...
                     failonerror: true)
            {
                classpath() {
                    ...
                    pathelement(location: pluginArifact('javax.servlet:servlet-api'))
                    ...
                    pathelement(location: pluginArifact('commons-codec:commons-codec'))
                    pathelement(location: pluginArifact('bouncycastle:bcprov-jdk15'))
                }
                ...
                for ( e in systemProperties ) {
                  sysproperty(key: e.key, value: e.value)
                }
