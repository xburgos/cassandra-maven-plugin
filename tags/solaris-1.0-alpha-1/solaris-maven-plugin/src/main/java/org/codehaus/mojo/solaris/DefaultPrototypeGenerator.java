    ...
    implements PrototypeGenerator
{
    ...
    public Iterator generatePrototype( File packageRoot, List prototypeEntryCollections, List prototypeEntries,
                                       PrototypeEntryCollection defaultDirectoryEntry,
                                       PrototypeEntryCollection defaultFileEntry )
        throws MojoFailureException
    {
        prototypeEntryCollections = getEntries( prototypeEntryCollections );

        // -----------------------------------------------------------------------
        // Validate
        // -----------------------------------------------------------------------

        for ( Iterator it = prototypeEntryCollections.iterator(); it.hasNext(); )
        {
            PrototypeEntryCollection collection = (PrototypeEntryCollection) it.next();
        ...
        prototypeEntryCollections.add( 0, defaultDirectoryCollection );
        prototypeEntryCollections.add( 0, defaultFileCollection );
        ...
        if ( prototypeEntries != null )
        {
            collectedPrototypeEntries.addAll( prototypeEntries );
        }
