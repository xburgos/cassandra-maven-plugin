    ...
    implements LogEnabled
{
                                 ...
                                 boolean skipPlatformPostfix ) throws RpmFormattingException
    {
        ...
        else
        {
            ...
            {
                String[] versionInfo =
                    formatProjectVersionAndRelease( project, platformPostfix, skipPlatformPostfix );
     ...
     */
    public String[] formatProjectVersionAndRelease( MavenProject project, String platformPostfix, boolean skipPlatformPostfix ) throws RpmFormattingException
    {
