...
public class LinuxReleaseFileDistributionDetector implements SystemDistributionDetector, LogEnabled
{
    ...
    private static final List LINUX_RELEASE_FILES;
    
    static
    {
        List releaseFiles = new ArrayList();
        
        releaseFiles.add( FEDORA_CORE_RELEASE_FILE );
        releaseFiles.add( REDHAT_RELEASE_FILE );
        releaseFiles.add( GENTOO_RELEASE_FILE );
        releaseFiles.add( UBUNTU_RELEASE_FILE );
        
        LINUX_RELEASE_FILES = releaseFiles;
    }
