...
/**
 * Deploys the POM for a project to the remote repository.
 *
    ...
    extends AbstractDeployMojo
{
        ...
        throws MojoExecutionException, MojoFailureException
    {
        ...
        Artifact artifact = artifactFactory.createBuildArtifact( project.getGroupId(), project.getArtifactId(), project.getVersion(), "pom" );
