    ...
    extends AbstractMojo
{
    ...
    /**
     * Classpath for ws_ant script.
     * 
     * @parameter expression="${was6.wsAntClasspath}" default-value="${wasHome}/plugins/com.ibm.ws.runtime_6.1.0.jar"
     * @required
     */
    private String wsAntClasspath;
        ...
        throws MojoExecutionException
    {
        try
        {
            ...
            addProperty( projectElement, "wsAntClasspath", wsAntClasspath );
        ...
        throws MojoExecutionException
    {
        ...
        if ( value != null )
        {
            ...
            {
                attribute.setText( ( (File) value ).getAbsolutePath() );
            }
        ...
        throws MojoExecutionException
    {
        try
        {
            List compileClasspathElementsList = mavenProject.getRuntimeClasspathElements(); // hmm, shouldn't compile be
            // sufficient? The nemo
            // project fails on
            // multibuild with compile
            // scope - but succeeds with
            // runtime.
