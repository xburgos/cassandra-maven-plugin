    ...
    extends TestCase
{
    ...
    public void testMultipleRanges_ShouldFailWhenUpperOverlapsWithAnotherLower()
    {
        ...
        try
        {
            new VersionRangeParser().parseRpmVersionRestrictions( range );
        ...
        throws InvalidVersionSpecificationException
    {
        ...
        expected.add( VersionRangeParser.VERSION_EQUAL_OR_GREATER_THAN + "1.0" );
        expected.add( VersionRangeParser.VERSION_LESS_THAN + "2.0" );
        expected.add( VersionRangeParser.VERSION_GREATER_THAN + "2.0" );
        expected.add( VersionRangeParser.VERSION_EQUAL_OR_LESS_THAN + "3.0" );

        List restrictions = new VersionRangeParser().parseRpmVersionRestrictions( range );
    ...
    public void testSanityChecks_LowerBoundNonInclusive_UpperBoundaryInclusivenessNotSpecified()
    {
        ...
        try
        {
            new VersionRangeParser().sanityCheckRange( range );
        ...
        throws InvalidVersionSpecificationException
    {
        ...
        new VersionRangeParser().parseRange( range, result, new HashMap(), new HashMap() );
        ...
        throws InvalidVersionSpecificationException
    {
        ...
        new VersionRangeParser().parseRange( versionRange, result, new HashMap(), new HashMap() );
