...
public class RpmSpecFormatter
{
    ...
    public RpmSpecFormatter( MavenProjectBuilder projectBuilder, ArtifactFactory artifactFactory, RpmInfoFormatter rpmInfoFormatter )
    {
     ...
     */
    public String buildSpec( MavenProject project, ArtifactRepository localRepository, Set depends, Set provides, File destDir, String prefix, String release, boolean rpmNoStrip, File preInstallFile, File postInstallFile, File postUninstallFile , File preUninstallFile, String platformPostfix, boolean skipPlatformPostfix)
        throws RpmFormattingException
    {
        // NOTE: The comments sprinkled throughout this method are Perl code taken from the ezbuild system.
        // I'm not enough of an expert on RPMs to be sure this is absolutely correct...
        ...
        String[] versionInfo = rpmInfoFormatter.formatProjectVersionAndRelease( project, release, platformPostfix, skipPlatformPostfix );
	...
	// lwt - Useful for pre-install and post-install scripts
        ...
        throws RpmFormattingException
    {
        if ( !depends.isEmpty() )
        {
            ...
            for ( Iterator it = depends.iterator(); it.hasNext(); )
            {
                ...
                Artifact pomArtifact = artifactFactory.createProjectArtifact( dependency.getGroupId(), dependency.getArtifactId(),
