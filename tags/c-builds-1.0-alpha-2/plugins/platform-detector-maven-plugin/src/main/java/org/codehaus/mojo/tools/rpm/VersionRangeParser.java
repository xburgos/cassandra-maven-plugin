...
/**
 * @plexus.component role="org.codehaus.mojo.tools.rpm.VersionRangeParser" role-hint="default"
 * @author jdcasey
 */
public class VersionRangeParser
{

    public static final String VERSION_IS_EXACTLY = " = ";

    public static final String VERSION_EQUAL_OR_GREATER_THAN = " >= ";

    public static final String VERSION_EQUAL_OR_LESS_THAN = " <= ";

    public static final String VERSION_GREATER_THAN = " > ";

    public static final String VERSION_LESS_THAN = " < ";

    public List parseRpmVersionRestrictions( String version )
        ...
        throws InvalidVersionSpecificationException
    {
        ...
        if ( index < 0 )
        {
            ...
            rpmVersionRestrictions.add( VERSION_IS_EXACTLY + process );
        ...
        else
        {
            ...
            if ( lowerBound != null )
            {
                ...
                {
                    rpmVersionRestrictions.add( VERSION_EQUAL_OR_GREATER_THAN + lowerBound );
                }
                else
                {
                    rpmVersionRestrictions.add( VERSION_GREATER_THAN + lowerBound );
                }
            ...
            if ( upperBound != null )
            {
                ...
                {
                    rpmVersionRestrictions.add( VERSION_EQUAL_OR_LESS_THAN + upperBound );
                }
                else
                {
                    rpmVersionRestrictions.add( VERSION_LESS_THAN + upperBound );
                }
