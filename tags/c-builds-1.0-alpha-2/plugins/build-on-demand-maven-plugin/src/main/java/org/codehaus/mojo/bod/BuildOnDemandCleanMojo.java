...
/**
 * Removes project dependencies as needed.
 *
 * @goal clean
 * @phase clean
 */
public class BuildOnDemandCleanMojo extends AbstractMojo 
{
    ...
    static
    {
        ...
        config.setGoals( Collections.singletonList( "post-clean" ) );
        ...
        throws MojoFailureException
    {
        ...
        try
        {
            ...
            request.setBuildPrototype( CLEAN_CONFIGURATION );
            ...
            dependencyBuilder.removeDependencies( request );
        }
        catch ( BuildException e )
        {
            MojoFailureException error = new MojoFailureException( e, "Failed to remove dependency projects.",
                                                                   "Failed to remove dependency projects. Reason: "
                                                                       + e.getMessage() );
