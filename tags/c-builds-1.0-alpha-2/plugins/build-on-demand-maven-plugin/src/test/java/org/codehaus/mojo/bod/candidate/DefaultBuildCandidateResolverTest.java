...
import org.codehaus.mojo.bod.candidate.DefaultBuildCandidateResolver;
import org.codehaus.plexus.logging.Logger;
import org.easymock.MockControl;

public class DefaultBuildCandidateResolverTest
    extends TestCase
{
    ...
    public void testShouldConstructWithMetadataSourceProjectBuilderAndLogLevel()
    {
        ...
        new DefaultBuildCandidateResolver( artifactMetadataSource, projectBuilder, artifactFactory, artifactCollector,
    ...
    {
        new DefaultBuildCandidateResolver();
    }
    ...
    public void testShouldRemoveOneBuildInProgress()
    {
        ...
        DefaultBuildCandidateResolver resolver = new DefaultBuildCandidateResolver( artifactMetadataSource, projectBuilder,
    ...
    public void testShouldFailToCreateDependencyArtifacts()
    {
        ...
        DefaultBuildCandidateResolver resolver = new DefaultBuildCandidateResolver( null, null, artifactFactory, artifactCollector,
                                                                      Logger.LEVEL_DISABLED );
        ...
        throws BuildException
    {
        ...
        List result = resolver.resolveCandidates( project, currentBuilds, null, completedBuilds, true );
