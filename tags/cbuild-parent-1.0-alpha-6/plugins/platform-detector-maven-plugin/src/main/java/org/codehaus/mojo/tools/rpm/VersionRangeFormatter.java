...
public class VersionRangeFormatter
{
    ...
    protected void checkForOverlaps( Map rawLowerBoundsWithInclusiveness,
        Map rawUpperBoundsWithInclusiveness, String originalVersion )
        throws InvalidVersionSpecificationException
    {
    ...
    protected void parseRange( String range, List rpmVersionRestrictions,
        Map rawLowerBoundsWithInclusiveness, Map rawUpperBoundsWithInclusiveness )
        throws InvalidVersionSpecificationException
    {
