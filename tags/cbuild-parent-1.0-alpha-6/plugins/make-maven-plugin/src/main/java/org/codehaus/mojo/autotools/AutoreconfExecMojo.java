    ...
    public void execute() throws MojoExecutionException
    {
        ...
        if ( arguments != null )
        {
            for ( Iterator it = arguments.iterator(); it.hasNext(); )
            {
                ...
                exec.createArgument().setLine( option );
            }
        }
        ...
        try
        {
            ...
            if ( result != 0 )
            {
                throw new MojoExecutionException( command + " command returned an exit value != 0. Aborting build; see debug output for more information." );
            }
        }
