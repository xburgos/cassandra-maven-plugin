    ...
    extends AbstractRpmInstallMojo
{
        ...
        throws MojoExecutionException, MojoFailureException
    {
        ...
        if ( rpmFile == null )
        {
            throw new MojoFailureException( this, "RPM file does not exist.", "RPM file has not been set on project artifact for: " + session.getCurrentProject().getId() );
        }
        ...
        try
        {
            install( session.getCurrentProject(), release, forceInstall );
        }
