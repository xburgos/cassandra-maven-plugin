...
//
// NOTE: This is snatched up from Groovy's JavaAwareCompilationUnit and massaged up to behave as desired.
//
...
/**
 * Custom Groovy compilation unit to generate Java stubs for Groovy sources.
 *
 * @version $Id$
 */
