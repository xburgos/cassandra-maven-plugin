...
import org.codehaus.mojo.groovy.plexus.GroovyComponentFactory;
import org.codehaus.mojo.groovy.plexus.GroovyResourceLoaderImpl;
...
{
    /**
     * The source of the script to execute.  Value can be a URL, File reference
     * or inline Groovy code.
     *
     * @parameter
     * @required
     */
    ...
    protected void doExecute() throws Exception {
        ...
        //
        // TODO: We should see if we can dynamic create this instance once its accessed
        //
        ...
        obj.setProperty("fail", new FailClosure());
    ...
    /**
     * A closure to implement fail() functionality for script execution.
     */
    private class FailClosure
        extends Closure
    {
        public FailClosure() {
            super(ExecuteMojo.this);
        }
