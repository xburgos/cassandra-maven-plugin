    ...
    extends AbstractPrototypeEntry
{
    ...
    protected SinglePrototypeEntry( boolean requiresSlashPrefixOnPaths, String pkgClass, String mode, String user,
                                    String group, String path, String realPath )
    {
    ...
    public void validate( Defaults defaults )
    {
        ...
        if ( requiresSlashPrefixOnPaths && !path.startsWith( "/" ) )
        {
            path = "/" + path;
        }
    }
