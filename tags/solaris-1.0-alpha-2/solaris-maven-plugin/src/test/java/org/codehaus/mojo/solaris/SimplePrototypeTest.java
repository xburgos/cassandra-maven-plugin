    ...
    extends PlexusTestCase
{
        ...
        throws Exception
    {
        ...
        prototypeEntries.add( new DirectoryCollection( null, "?", "?", "?",
                                                       new String[]{"opt", "opt/jb"}, null));
        prototypeEntries.add( new DirectoryCollection( null, null, "myservice", "myservice",
                                                       new String[]{"opt/jb/tips-handler/**"}, null));

        prototypeEntries.add(new FileCollection( null, null, "myservice", "myservice",
                                                 new String[]{"opt/jb/tips-handler/**"}, null ) );
        prototypeEntries.add( new FileCollection( "conf", null, "myservice", "myservice",
                                                 new String[]{"opt/jb/tips-handler/etc/*"}, null));
        prototypeEntries.add(new FileCollection( null, null, "myservice", "myservice",
                                                 new String[]{"opt/jb/tips-handler/etc/*.template"}, null ) );
        prototypeEntries.add( new FileCollection( null, "0755", "myservice", "myservice",
