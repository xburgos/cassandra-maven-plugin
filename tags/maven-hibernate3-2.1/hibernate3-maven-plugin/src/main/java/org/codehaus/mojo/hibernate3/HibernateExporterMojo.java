...
// -------------------------- OTHER METHODS --------------------------
        ...
        throws MojoExecutionException
    {
        ...
        // now let's set the template path for custom templates
        if ( getComponentProperty( "template" ) != null )
        {
            File templatePathDefault = new File( getProject().getBasedir(), "/src/main/config/templates" );
            String templatePath = getComponentProperty( "templatepath", templatePathDefault.getPath() );
            getLog().info( "Exporter will use templatepath : " + templatePath );
