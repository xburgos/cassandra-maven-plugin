...
{
    /**
     * Extra files to be deleted in addition to the default directories.  Defaults to all <tt>target</tt> directories and <tt>build.log</tt> files under <tt>src/it</tt>.
     *
     * @parameter
     */
    FileSet[] filesets
