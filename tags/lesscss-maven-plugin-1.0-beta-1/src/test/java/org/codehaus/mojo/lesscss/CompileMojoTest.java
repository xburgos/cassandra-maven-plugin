    ...
    extends AbstractMojoTestCase
{
    ...
    @Test
    public void testExecutionNotModified()
        throws Exception
    {
        files = new String[] { "less.less" };
    ...
    @Test
    public void testExecutionIncludedFilesEmpty()
        throws Exception
    {
        whenNew( DirectoryScanner.class ).withNoArguments().thenReturn( directoryScanner );
        when( directoryScanner.getIncludedFiles() ).thenReturn( new String[] {} );
    ...
    @Test
    public void testExecutionIncludedFilesNull()
        throws Exception
    {
        whenNew( DirectoryScanner.class ).withNoArguments().thenReturn( directoryScanner );
        when( directoryScanner.getIncludedFiles() ).thenReturn( null );
    ...
    public void testExecutionIOExceptionWhenCreatingLessSource()
        throws Exception
    {
        files = new String[] { "less.less" };
    ...
    @Test( expected = MojoExecutionException.class )
    public void testExecutionLessExceptionWhenCompilingLessSource()
        throws Exception
    {
        files = new String[] { "less.less" };
    ...
    @Test
    public void testExecutionWithCustomLessJs()
        throws Exception
    {
    ...
    @Test
    public void testExecutionMakeDirsWhenOutputDirectoryDoesNotExists()
        throws Exception
    {
        files = new String[] { "less.less" };
    ...
    @Test( expected = MojoExecutionException.class )
    public void testExecutionMakeDirsFailsWhenOutputDirectoryDoesNotExists()
        throws Exception
    {
        files = new String[] { "less.less" };
