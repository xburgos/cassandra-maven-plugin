    ...
    extends AbstractMojoTestCase
{
    ...
    public void testExecutionFileNotFoundException()
        throws Exception
    {
        whenNew( DirectoryScanner.class ).withNoArguments().thenReturn( directoryScanner );
        when( directoryScanner.getIncludedFiles() ).thenReturn( new String[] { "less.less" } );
    ...
    @Test( expected = MojoExecutionException.class )
    public void testExecutionIOException()
        throws Exception
    {
        whenNew( DirectoryScanner.class ).withNoArguments().thenReturn( directoryScanner );
        when( directoryScanner.getIncludedFiles() ).thenReturn( new String[] { "less.less" } );
