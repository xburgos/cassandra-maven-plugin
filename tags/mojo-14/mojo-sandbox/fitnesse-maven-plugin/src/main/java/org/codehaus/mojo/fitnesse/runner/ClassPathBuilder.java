...
public class ClassPathBuilder
{
    ...
    public String getPath( List<ClassPathSubstitution> pSubstitutions, Log pLog ) throws MojoExecutionException
    {
    ...
    String transformPath( String pOriginalPath, List<ClassPathSubstitution> pSubstitutions )
    {
        String curPath = pOriginalPath;
        for ( ClassPathSubstitution curSub : pSubstitutions )
        {
