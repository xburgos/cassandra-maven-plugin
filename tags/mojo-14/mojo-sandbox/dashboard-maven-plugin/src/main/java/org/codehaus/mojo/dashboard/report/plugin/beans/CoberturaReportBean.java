...
public class CoberturaReportBean extends AbstractReportBean
{
     ...
     * @param projectName
     */
    public CoberturaReportBean( String projectName )
    {
    ...
    public void merge( CoberturaReportBean dashboardReport )
    {
        if ( dashboardReport != null )
        {
            ...
            this.numberOfCoveredBranches = this.numberOfCoveredBranches + dashboardReport.getNumberOfCoveredBranches();
            this.numberOfCoveredLines = this.numberOfCoveredLines + dashboardReport.getNumberOfCoveredLines();
            this.numberOfValidBranches = this.numberOfValidBranches + dashboardReport.getNumberOfValidBranches();
            this.numberOfValidLines = this.numberOfValidLines + dashboardReport.getNumberOfValidLines();
