...
public class JDependReportBean extends AbstractReportBean
{
     ...
     * @param projectName
     */
    public JDependReportBean( String projectName )
    {
     ...
     */
    public void merge( JDependReportBean dashboardReport )
    {
        if ( dashboardReport != null )
        {
            this.sumAC = this.sumAC + dashboardReport.getSumAC();
            this.nbPackages = this.nbPackages + dashboardReport.getNbPackages();
            ...
            this.packages.addAll( dashboardReport.getPackages() );
