...
public class SurefireReportBean extends AbstractReportBean
{
     ...
     * @param projectName
     */
    public SurefireReportBean( String projectName )
    {
     ...
     */
    public void merge( SurefireReportBean dashboardReport )
    {
        if ( dashboardReport != null )
        {
            this.nbTests = this.nbTests + dashboardReport.getNbTests();

            this.nbErrors = this.nbErrors + dashboardReport.getNbErrors();

            this.nbFailures = this.nbFailures + dashboardReport.getNbFailures();

            this.nbSkipped = this.nbSkipped + dashboardReport.getNbSkipped();

            this.elapsedTime = this.elapsedTime + dashboardReport.getElapsedTime();
