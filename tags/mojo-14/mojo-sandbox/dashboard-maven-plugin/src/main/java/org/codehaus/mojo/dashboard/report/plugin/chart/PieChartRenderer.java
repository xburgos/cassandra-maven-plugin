...
public class PieChartRenderer extends AbstractChartRenderer
{
     ...
     * @param strategy
     */
    public PieChartRenderer( IDashBoardReportBean dashboardReport, IDatasetStrategy strategy )
    {
    ...
    /* (non-Javadoc)
     * @see org.codehaus.mojo.dashboard.report.plugin.chart.AbstractChartRenderer#createChart(org.codehaus.mojo.dashboard.report.plugin.beans.IDashBoardReportBean)
     */
    protected void createChart( IDashBoardReportBean dashboardReport )
    {
        ...
        report = ChartFactory.createPieChart( dashboardReport.getProjectName(), dataset, true, true, false );
        ...
        plot.setLabelFont( new Font( "SansSerif", 0, PieChartRenderer.FONT_SIZE ) );
