...
public class RatReportMojo extends AbstractRatMojo implements MavenReport
{
     ...
     * @throws MojoExecutionException An error occurred while searching for the artifact
     *   file.
    ...
    /**
     * Creates the report as a string. Currently, this string will
     * be embedded verbatimly into the report document.
     * @throws MojoFailureException An error in the plugin configuration was detected.
    ...
    {
        return ResourceBundle.getBundle( "rat-report", locale, getClass().getClassLoader() );
    }

    /**
     * Returns the reports description.
     * @param locale Requested locale of the bundle
     * @return Report description, as given by the key "report.rat.description"
     *   in the bundle.
     */
     ...
     * @param locale Requested locale of the bundle
     * @return Report name, as given by the key "report.rat.name"
     *   in the bundle.
     */
