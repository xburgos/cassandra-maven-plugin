...
//        return retValue;
        ...
        throws ComponentConfigurationException
    {
        ...
        for ( int i = 0; i < items; i++ )
        {
            ...
            try
            {
                String implementation = childConfiguration.getAttribute( "implementation" );
                ...
                {
                    // TODO: could be either a Map or a List... let's go with Map for now.
                    type = Map.class;
                }
            }
            catch( Exception e )
            {
                // XXX: log? what can be done about it?
            }
