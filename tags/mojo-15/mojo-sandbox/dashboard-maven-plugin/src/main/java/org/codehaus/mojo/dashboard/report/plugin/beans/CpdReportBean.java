...
public class CpdReportBean extends AbstractReportBean
{
     ...
     * @param projectName
     */
    public CpdReportBean( String projectName )
    {
     ...
     */
    public void merge( CpdReportBean dashboardReport )
    {
        if ( dashboardReport != null )
        {
            this.nbClasses = this.nbClasses + dashboardReport.getNbClasses();

            this.nbDuplicate = this.nbDuplicate + dashboardReport.getNbDuplicate();
        }
    }
}
