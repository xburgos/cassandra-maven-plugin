...
implements ArchetypeFilesResolver
{
    ...
    public List getFilteredFiles ( List files, String filtered )
    {
        ...
        getLogger().debug("Scanned " +result.size()+
            " filtered files in "+ files.size() + " files");
    ...
    public List findOtherResources ( int level, List files, String languages )
    {
        ...
        List result = scanner.scan ( files );
        getLogger().debug("Scanned " +result.size() + 
            " other resources in "+files.size()+ " files at level "+level);
    ...
    public List findOtherSources ( int level, List files, String languages )
    {
        ...
        List result = scanner.scan ( files );
        getLogger().debug("Scanned " +result.size() +
            " other sources in "+  files.size()+" files at level " +level);
    ...
    public List findResourcesTestFiles ( List files, String languages )
    {
        ...
        List result = scanner.scan ( files );
        getLogger().debug("Scanned " +result.size() + 
            " test resources in "+ files.size()+" files");
    ...
    public List findSiteFiles ( List files, String languages )
    {
        ...
        List result = scanner.scan ( files );
        getLogger().debug("Scanned " +result.size() +
            " site resources in "+ files.size()+ " files");
    ...
    public List findSourcesMainFiles ( List files, String languages )
    {
        ...
        List result = scanner.scan ( files );
        getLogger().debug("Scanned "+ result.size() + " sources in " +
            files.size()+" files");
    ...
    public List findSourcesTestFiles ( List files, String languages )
    {
        ...
        List result = scanner.scan ( files );
        getLogger().debug("Scanned " +result.size() +
            " test sources in "+ files.size()+ " files");
    ...
    public List getPackagedFiles ( List files, String packageName )
    {
        ...
        getLogger().debug("Scanned " +packagedFiles.size() +
            " pachaged files in "+ files.size()+ " files");
    ...
    throws IOException
    {
        getLogger().debug("Resolving package");
    ...
    public List getUnfilteredFiles ( List files, String filtered )
    {
        ...
        List result = scanner.scan ( files );
        getLogger().debug("Scanned " +result.size() +
            " unfiltered files in "+ files.size()+ " files");
    ...
    public List getUnpackagedFiles ( List files, String packageName )
    {
        ...
        getLogger().debug("Scanned " +unpackagedFiles.size() + 
            " unpachaged files in "+ files.size() +" files");
    ...
    throws IOException
    {
        ...
        getLogger().debug("Found " + absoluteFiles.size()+
            " potential archetype files");
        ...
        getLogger().debug("Found " + files.size()+
            " archetype files for package resolution ");
...
//            getLogger().debug("Using file "+minusLanguage);

            String filePackage;
            if (minusLanguage.contains("/"))
            {
                filePackage =
                    StringUtils.replace (
